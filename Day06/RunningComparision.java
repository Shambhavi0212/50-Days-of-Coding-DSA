...
They each ran for N days — on the i-th day, Alice ran Ai meters and Bob ran Bi meters.
...
Output “Yes” if both Alice and Bob are happy on a given day and “No” if not.
*/
...
- Each test case consists of three lines of input:
    ...
    2. The second line contains N space-separated integers A1, A2, ..., AN — the distances run by Alice on the N days.
    3. The third line of each test case contains N space-separated integers B1, B2, ..., BN — the distances run by Bob on the N days.
*/
...
/*
Explanation:
Test case 1: Alice is unhappy on the first day, since she ran 100 meters but Bob ran 300; and 300 is more than twice of 100. Similarly, Bob is unhappy on the third day. Both Alice and Bob are happy on the second day, so the answer is 1.
